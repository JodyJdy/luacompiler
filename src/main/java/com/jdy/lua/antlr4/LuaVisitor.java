...
public interface LuaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link LuaParser#require}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRequire(LuaParser.RequireContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LuaParser#laststat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLaststat(LuaParser.LaststatContext ctx);
	/**
