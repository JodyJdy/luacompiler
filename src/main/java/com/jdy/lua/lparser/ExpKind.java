...
public enum ExpKind {
    ...
    /** 常量，info存储在常量数组中的下标 */
    VK(4),  /** constant in 'constants'; info = index of constant in 'constants' */
    ...
    // local 变量
    VLOCAL(9),  /** local variable; var.registerIndex = register index;
              var.actVarIndex = relative index in 'actvar.arr'  */
    // upvalue 变量
