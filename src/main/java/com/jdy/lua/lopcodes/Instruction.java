...
public class Instruction {
    ...
    public static OpCode getOpCode(Instruction instruction){
        return getOpCode(instruction.instruction);
    }
    ...
    public static void setOpCode(Instruction instruction,OpCode opCode){
        ...
        instruction.instruction = (instruction.instruction & mask0(SIZE_OP,POS_OP)) | ((code << POS_OP) & mask1(SIZE_OP,POS_OP));
    }
    ...
    public static int getArg(Instruction i,int pos,int size){
        return (i.instruction >> pos) & mask1(size,0);
    }
    public static void setArg(Instruction i, int v , int pos, int size){
        i.instruction = (i.instruction & mask0(size,pos)) | ((v << pos) & mask1(size,pos));
    }
    ...
    public static void main(String[] args) {
       Instruction i =create_ABCK(0,1,2,3,1);
        System.out.println(getArgA(i));
        System.out.println(getArgB(i));
        System.out.println(getArgC(i));
        System.out.println(getArgk(i));
